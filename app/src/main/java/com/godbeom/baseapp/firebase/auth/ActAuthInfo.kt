package com.godbeom.baseapp.firebase.auth
...
class ActAuthInfo : BaseActivity() {

    private val TAG = "MainActivity"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_act_auth_info)
         // it's a sample
    }
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
            ...
            this, object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                override fun onCodeSent(
                    ...
                    this@ActAuthInfo.enableUserManuallyInputCode()
                }
